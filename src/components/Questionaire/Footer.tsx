...
const QuestionnaireFooter: React.FC = () => {
  return (
    <AppBar position="fixed" style={{  top: 'auto', bottom: 0,height: '8vh', display: 'flex', justifyContent: 'center',  backgroundColor: "#007BB7" }}>
      <Toolbar disableGutters>
        <Box sx={{  height: '100%', width: '100%'}}>
          <Button disabled color="inherit" sx={{width: '32%', padding: '1rem', borderRight: '2px solid #F8FAF8',fontFamily: 'Arial, sans-serif', gap: 1, display: 'none' }}>
            <PauseIcon style={{ fontSize: "20px" }} />Suspend
          </Button>
        </Box>
        ...
        <Box sx={{  height: '100%', width: '100%', display: 'flex', justifyContent: 'flex-end' }}>
          <Button color="inherit" sx={{ width: '32%', padding: '1rem', borderLeft: '2px solid #F8FAF8', fontFamily: 'Arial, sans-serif', color: '#FFFFFF', gap: 1 }}>
            <SettingsIcon style={{ fontSize: "18px" }} />Navigator
          </Button>
          <Button color="inherit" sx={{ width: '32%', padding: '1rem', borderLeft: '2px solid #F8FAF8', fontFamily: 'Arial, sans-serif', color: '#FFFFFF', gap: 1 }}>
