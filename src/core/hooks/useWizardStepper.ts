...
export function useWizardStep<TKey extends StepKey, TFormValue, TProps>(
  map: WizardStepMap<TKey, TFormValue, TProps>,
  formatValues: (
...
type WizardStepperProps<TFormValue, TKey> = {
...
export type WizardStepMap<TKey extends StepKey, TFormValue, TProps> = {
  [k in TKey]: {
    ...
    content(
      stepProps: WizardStepperProps<TFormValue, TKey> & TProps
    ): ReactElement;
  };
};
